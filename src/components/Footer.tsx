      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <Link href="/" className="text-xl font-bold text-[#FCF3E4]">
                Astro Vedic Kundli
              </Link>
            </div>
            <p className="text-sm text-[#FCF3E4]/70 mb-6">
              Discover your cosmic destiny through ancient Vedic wisdom and personalized astrological insights.
            </p>
        ...
        <div className="mt-12 border-t border-[#FCF3E4]/20 pt-8">
          <p className="text-sm text-[#FCF3E4]/60 text-center">
            &copy; {currentYear} Astro Vedic Kundli. All rights reserved. Made with ❤️ for cosmic souls.
          </p>
        </div>
      </div>
    </footer>
